...
const { pick, pickBy, identity, toArray, _, toString, get, set, isArray } = lodash__default["default"];

const IS_HIDE_INTERNALS = conf__default["default"].NODE_ENV === 'production';
...
function throwAuthenticationError () {
    throw new apolloServerErrors.AuthenticationError('No or incorrect authentication credentials')
}

exports.formatError = formatError;
exports.safeFormatError = safeFormatError;
exports.throwAuthenticationError = throwAuthenticationError;
